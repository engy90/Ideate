...
public class AddIdeaPage {
	...
	By clickAddNewRE = By.xpath(
			"/html/body/ite-root/ite-main/div/div/div/ite-idea-add-edit-page/form/div/div[2]/div[1]/div/div[2]/div");
	By clickArticle = By.xpath("//article[@class='relevant-experience']");
	By addRE = By.xpath("//input[@placeholder='Experience']");
	// By clickRE =
	// By.xpath("/html/body/ite-root/ite-main/div/div/div/ite-idea-add-edit-page/form/div/div[2]/div[1]/div/div[2]/div");
	// By addRE = By.xpath("//input[@placeholder='Experience']") ;
	By targetMarketSector = By.xpath(
			"//ng-select[@name='verticals']//div[@class='ng-select-container']//div[@class='ng-value-container']//div[@class='ng-input']//input[@role='combobox']");
	By businessToConsumer = By.xpath("//*[text()='Business to Consumer']");
	By missingSkills = By.xpath(
			"/html/body/ite-root/ite-main/div/div/div/ite-idea-add-edit-page/form/div/div[2]/div[1]/div/div[4]/ng-select/div/div/div[1]");
	By selectSkill = By.xpath("//*[text()='BA']");
	By submitBtn = By.xpath("//button[@type='submit']");
	By justNow = By.xpath(
			"/html/body/ite-root/ite-main/div/div/div/ite-idea-details/div/div[1]/div[1]/ite-idea-detail-card/div/div/div[1]");
