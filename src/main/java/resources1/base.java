...
public class base {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(
				"C:\\Users\\ihuser\\git\\Ideate\\src\\main\\java\\resources1\\data.properties");
		prop1.load(fis);

		prop2 = new Properties();
		FileInputStream fis1 = new FileInputStream(
				"C:\\Users\\ihuser\\git\\Ideate\\src\\main\\java\\resources1\\qa.properties");
		prop2.load(fis1);

		prop3 = new Properties();
		FileInputStream fis2 = new FileInputStream(
				"C:\\Users\\ihuser\\git\\Ideate\\src\\main\\java\\resources1\\uat.properties");
		prop3.load(fis2);
		...
		if (prop1.getProperty("testEnvironmet").equalsIgnoreCase("qa")) {
			...
			if (browsertype.equalsIgnoreCase("chrome")) {
				...
				System.setProperty("webdriver.chrome.driver",
						"C:\\Users\\ihuser\\git\\Ideate\\src\\main\\java\\drivers\\chromedriver.exe");
			...
			if (browsertype.equalsIgnoreCase("chrome")) {
				System.out.println(browsertype);
				System.setProperty("webdriver.chrome.driver",
						"C:\\Users\\ihuser\\git\\Ideate\\src\\main\\java\\drivers\\chromedriver95.exe");
				driver = new ChromeDriver();
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				driver.get(prop3.getProperty("url"));
				driver.manage().window().maximize();
			...
			if (workbook.getSheetName(i).equalsIgnoreCase("testdata")) {
				...
				if (prop1.getProperty("testEnvironmet").equalsIgnoreCase("qa")) {
					fos = new FileOutputStream(
							"C:\\Users\\ihuser\\git\\Ideate\\src\\main\\java\\resources1\\testdataQA1.xlsx");
				} else {
					fos = new FileOutputStream(
							"C:\\Users\\ihuser\\git\\Ideate\\src\\main\\java\\resources1\\testdataUAT.xlsx");

				}
				// FileOutputStream fos = new
				// FileOutputStream("C:\\Users\\Engy.Moghazy\\eclipse-workspace2forGIT\\Ideate\\src\\main\\java\\resources1\\testdata.xlsx");
				workbook.write(fos);
				workbook.close();
				fos.close();
